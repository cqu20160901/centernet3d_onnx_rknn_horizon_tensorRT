...
def inference(model_path, image_path, cal_path, input_layout, input_offset):
    ...
    image_data = precess_image(origin_image, input_w, input_h)
...
if __name__ == '__main__':
    ...
    model_path = './model_output/centernet3d_quantized_model.onnx'
    image_path = './test.png'
    cal_path = './test.txt'
    input_layout = 'NHWC'
    input_offset = 128

    inference(model_path, image_path, cal_path, input_layout, input_offset)
